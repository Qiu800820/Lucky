...
class Ui_Lucky(object):
    def setupUi(self, Lucky):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(250, 60, 531, 31))
        ...
        self.label.setGeometry(QtCore.QRect(250, 100, 54, 12))
        self.label.setObjectName("label")
        self.result_table = QtWidgets.QTableWidget(self.centralwidget)
        self.result_table.setGeometry(QtCore.QRect(250, 120, 531, 211))
        ...
        self.lucky.setGeometry(QtCore.QRect(260, 350, 511, 23))
        self.lucky.setObjectName("lucky")
        self.result_edit = QtWidgets.QTextEdit(self.centralwidget)
        self.result_edit.setGeometry(QtCore.QRect(250, 390, 531, 201))
        ...
        self.strategySlider.setGeometry(QtCore.QRect(350, 20, 160, 19))
        ...
        self.strategy_count.setGeometry(QtCore.QRect(580, 20, 16, 16))
        self.strategy_count.setObjectName("strategy_count")
        self.count = QtWidgets.QLabel(self.centralwidget)
        self.count.setGeometry(QtCore.QRect(370, 100, 54, 12))
        self.count.setObjectName("count")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(310, 100, 54, 12))
        self.label_3.setObjectName("label_3")
        self.lcdNumber = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcdNumber.setGeometry(QtCore.QRect(530, 20, 41, 16))
    ...
    def retranslateUi(self, Lucky):
        ...
        self.label_2.setText(_translate("Lucky", "历史最大遗漏数："))
